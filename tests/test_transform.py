...
class TestTransform(unittest.TestCase):
    ...
    def test_multi_type_object_transform(self):
        schema = {
            ...
            "properties": {
                "whatever": {"type": "date-time", "format": "date-time"}
            },
        }
    ...
    def test_datetime_transform(self):
        ...
        self.assertEqual(
            transformed_string_datetime,
            transform(
                string_datetime, schema, UNIX_SECONDS_INTEGER_DATETIME_PARSING
            ),
        )
        self.assertEqual(
            "1970-01-01T00:01:26.400000Z",
            transform(
                86400, schema, UNIX_MILLISECONDS_INTEGER_DATETIME_PARSING
            ),
        )
        self.assertEqual(
            transformed_string_datetime,
    ...
    def test_datetime_string_with_timezone(self):
        ...
        self.assertEqual(
            transformed_string_datetime, transform(string_datetime, schema)
        )
    ...
    def test_error_path(self):
        ...
        self.assertListEqual(
            [[], ["foo"]], sorted(e.path for e in trans.errors)
        )
    ...
    def test_unexpected_object_properties(self):
        ...
        self.assertDictEqual(
            {"good_property": "expected data"}, transformed_data
        )
    ...
    def test_unix_seconds_to_datetime(self):
        self.assertEqual(
            unix_seconds_to_datetime(0), "1970-01-01T00:00:00.000000Z"
        )
        self.assertEqual(
            unix_seconds_to_datetime(1502722441), "2017-08-14T14:54:01.000000Z"
        )

    def test_unix_seconds_to_datetime2(self):
        self.assertEqual(
            unix_milliseconds_to_datetime(0), "1970-01-01T00:00:00.000000Z"
        )
        self.assertEqual(
            unix_milliseconds_to_datetime(1502722441000),
            "2017-08-14T14:54:01.000000Z",
        )
...
class TestResolveSchemaReferences(unittest.TestCase):
    ...
    def test_refs_resolve_items(self):
        ...
        result = resolve_schema_references(schema, refs)
        self.assertEqual(
            result["properties"]["dogs"]["items"]["properties"]["breed"],
            {"type": "string"},
        )
    ...
    def test_refs_resolve_nested(self):
        ...
        result = resolve_schema_references(schema, refs)
        self.assertEqual(
            result["properties"]["thing"]["properties"]["name"]["type"],
            "string",
        )
