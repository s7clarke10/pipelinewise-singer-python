        ...
        self.assertEqual(
            [
                metrics.Point(
                    ...
                    0,
                    {"endpoint": "users", "status": "succeeded"},
                )
            ],
            got,
        )
...
class TestParse(unittest.TestCase):
    ...
    def test_parse_with_everything(self):
        point = metrics.parse(
            'INFO METRIC: {"type": "counter", "metric": "record_count", "value": 10, "tags": {"endpoint": "users"}}'  # noqa: E501
        )
        self.assertEqual(
            point,
    ...
    def test_parse_without_tags(self):
        point = metrics.parse(
            'INFO METRIC: {"type": "counter", "metric": "record_count", "value": 10}'
        )
        self.assertEqual(
