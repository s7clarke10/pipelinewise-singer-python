...
class TestGetBookmark(unittest.TestCase):
    def test_empty_state(self):
        ...
        self.assertEqual(
            bookmarks.get_bookmark(
                empty_state, "some_stream", "my_key", "default_value"
            ),
            "default_value",
        )
    ...
    def test_empty_bookmark(self):
        ...
        # Case with no value to fall back on
        self.assertIsNone(
            bookmarks.get_bookmark(empty_bookmark, "some_stream", "my_key")
        )

        # Case with a given default
        self.assertEqual(
            bookmarks.get_bookmark(
                empty_bookmark, "some_stream", "my_key", "default_value"
            ),
            "default_value",
        )
    ...
    def test_non_empty_state(self):
        ...
        self.assertEqual(
            bookmarks.get_bookmark(
                non_empty_state, stream_id_1, bookmark_key_1
            ),
            bookmark_val_1,
        )
        ...
        self.assertEqual(
            bookmarks.get_bookmark(
                non_empty_state, "some_stream", "my_key", "default_value"
            ),
            "default_value",
        )
        ...
        self.assertEqual(
            bookmarks.get_bookmark(
                non_empty_state, "some_stream", bookmark_key_1, "default_value"
            ),
            "default_value",
        )
        ...
        self.assertEqual(
            bookmarks.get_bookmark(
                non_empty_state, stream_id_1, "my_key", "default_value"
            ),
            "default_value",
        )
        ...
        self.assertEqual(
            bookmarks.get_bookmark(
                non_empty_state, stream_id_1, bookmark_key_1, "default_value"
            ),
            bookmark_val_1,
        )
...
class TestGetOffset(unittest.TestCase):
    def test_empty_state(self):
        ...
        # Case with a given default
        self.assertEqual(
            bookmarks.get_offset(empty_state, "some_stream", "default_value"),
            "default_value",
        )
    ...
    def test_empty_bookmark(self):
        ...
        # Case with a given default
        self.assertEqual(
            bookmarks.get_offset(
                empty_bookmark, "some_stream", "default_value"
            ),
            "default_value",
        )
    ...
    def test_non_empty_state(self):
        ...
        # Good stream
        self.assertEqual(
            bookmarks.get_offset(non_empty_state, stream_id_1), offset_val
        )
        ...
        self.assertEqual(
            bookmarks.get_offset(
                non_empty_state, "some_stream", "default_value"
            ),
            "default_value",
        )
        ...
        # Good stream
        self.assertEqual(
            bookmarks.get_offset(non_empty_state, stream_id_1, "default_value"),
            offset_val,
        )
...
class TestGetCurrentlySyncing(unittest.TestCase):
    def test_empty_state(self):
        ...
        # Case with a given default
        self.assertEqual(
            bookmarks.get_currently_syncing(empty_state, "default_value"),
            "default_value",
        )
    ...
    def test_non_empty_state(self):
        ...
        # Case with no value to fall back on
        self.assertEqual(
            bookmarks.get_currently_syncing(non_empty_state), stream_id_1
        )

        # Case with a given default
        self.assertEqual(
            bookmarks.get_currently_syncing(non_empty_state, "default_value"),
            stream_id_1,
        )
